...
import 'package:openapi/src/api/parent_type_resource_api.dart';
import 'package:openapi/src/api/public_user_resource_api.dart';
import 'package:openapi/src/api/shipment_type_resource_api.dart';
import 'package:openapi/src/api/user_resource_api.dart';

class Openapi {
  static const String basePath = r'http://192.168.42.152:8080';
  ...
  /// Get ParentTypeResourceApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  ParentTypeResourceApi getParentTypeResourceApi() {
    return ParentTypeResourceApi(dio, serializers);
  }
  ...
  /// Get ShipmentTypeResourceApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  ShipmentTypeResourceApi getShipmentTypeResourceApi() {
    return ShipmentTypeResourceApi(dio, serializers);
  }
