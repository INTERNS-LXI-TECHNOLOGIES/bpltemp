...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.divisosoft.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.divisosoft.security.DomainUserDetailsService", "createSpringSecurityUser");
