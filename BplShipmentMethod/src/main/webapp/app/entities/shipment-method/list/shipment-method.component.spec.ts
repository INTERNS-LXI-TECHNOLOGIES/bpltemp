...
import { sampleWithRequiredData } from '../shipment-method.test-samples';
...
describe('ShipmentMethod Management Component', () => {
  let comp: ShipmentMethodComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [ShipmentMethodComponent],
      providers: [
        provideHttpClient(),
        {
      ...
      .overrideTemplate(ShipmentMethodComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.shipmentMethods()[0]).toEqual(expect.objectContaining({ id: 28010 }));
  });

  describe('trackId', () => {
    it('Should forward to shipmentMethodService', () => {
      const entity = { id: 28010 };
      jest.spyOn(service, 'getShipmentMethodIdentifier');
      const id = comp.trackId(entity);
      expect(service.getShipmentMethodIdentifier).toHaveBeenCalledWith(entity);
