...
import { sampleWithRequiredData } from '../facility-type.test-samples';
...
describe('FacilityType Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.facilityTypes()[0]).toEqual(expect.objectContaining({ id: 18255 }));
  });

  describe('trackId', () => {
    it('Should forward to facilityTypeService', () => {
      const entity = { id: 18255 };
      jest.spyOn(service, 'getFacilityTypeIdentifier');
      const id = comp.trackId(entity);
      expect(service.getFacilityTypeIdentifier).toHaveBeenCalledWith(entity);
