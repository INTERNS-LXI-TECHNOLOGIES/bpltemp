...
class OrganizationResourceIT {
    ...
    public static Organization createEntity() {
        return new Organization().externalId(DEFAULT_EXTERNAL_ID).name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
    }
    ...
    public static Organization createUpdatedEntity() {
        return new Organization().externalId(UPDATED_EXTERNAL_ID).name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    }
    ...
    void putExistingOrganization() throws Exception {
        ...
        updatedOrganization.externalId(UPDATED_EXTERNAL_ID).name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateOrganizationWithPatch() throws Exception {
        ...
        partialUpdatedOrganization.externalId(UPDATED_EXTERNAL_ID).name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
