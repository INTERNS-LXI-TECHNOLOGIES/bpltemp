...
type OrganizationFormGroupContent = {
  ...
  externalId: FormControl<IOrganization['externalId']>;
  name: FormControl<IOrganization['name']>;
  description: FormControl<IOrganization['description']>;
  organizationType: FormControl<IOrganization['organizationType']>;
  organizationGroup: FormControl<IOrganization['organizationGroup']>;
  parentOrganization: FormControl<IOrganization['parentOrganization']>;
};
...
export class OrganizationFormService {
  createOrganizationFormGroup(organization: OrganizationFormGroupInput = { id: null }): OrganizationFormGroup {
    ...
    return new FormGroup<OrganizationFormGroupContent>({
      ...
      parentOrganization: new FormControl(organizationRawValue.parentOrganization),
    });
  }
