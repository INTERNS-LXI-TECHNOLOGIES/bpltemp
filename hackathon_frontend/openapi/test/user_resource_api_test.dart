...
void main() {
  ...
  group(UserResourceApi, () {
    ...
    //Future<AdminUserDTO> updateUser(String login, AdminUserDTO adminUserDTO) async
    test('test updateUser', () async {
      // TODO
    });

    //Future<AdminUserDTO> updateUser1(AdminUserDTO adminUserDTO) async
    test('test updateUser1', () async {
      // TODO
    });
