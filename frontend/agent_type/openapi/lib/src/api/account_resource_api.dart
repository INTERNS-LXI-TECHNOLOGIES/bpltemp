...
class AccountResourceApi {
  ...
  Future<Response<void>> changePassword({ 
    ...
    final _path = r'/api/account/change-password';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> finishPasswordReset({ 
    ...
    final _path = r'/api/account/reset-password/finish';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> requestPasswordReset({ 
    ...
    final _path = r'/api/account/reset-password/init';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
