...
import 'package:openapi/src/api/agent_type_resource_api.dart';
...
import 'package:openapi/src/api/organisation_resource_api.dart';
...
class Openapi {
  ...
  /// Get AgentTypeResourceApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  AgentTypeResourceApi getAgentTypeResourceApi() {
    return AgentTypeResourceApi(dio, serializers);
  }
  ...
  /// Get OrganisationResourceApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  OrganisationResourceApi getOrganisationResourceApi() {
    return OrganisationResourceApi(dio, serializers);
  }
