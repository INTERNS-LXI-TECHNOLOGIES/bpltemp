...
import 'package:openapi/src/api/contact_resource_api.dart';
import 'package:openapi/src/api/person_resource_api.dart';
...
class Openapi {
  ...
  /// Get ContactResourceApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  ContactResourceApi getContactResourceApi() {
    return ContactResourceApi(dio, serializers);
  }

  /// Get PersonResourceApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  PersonResourceApi getPersonResourceApi() {
    return PersonResourceApi(dio, serializers);
  }
