package com.lxisofttech.hackathonback.web.rest;

import static com.lxisofttech.hackathonback.domain.EmployeeAsserts.*;
import static com.lxisofttech.hackathonback.web.rest.TestUtil.createUpdateProxyForBean;
...
import com.lxisofttech.hackathonback.IntegrationTest;
import com.lxisofttech.hackathonback.domain.Employee;
import com.lxisofttech.hackathonback.repository.EmployeeRepository;
import com.lxisofttech.hackathonback.service.dto.EmployeeDTO;
import com.lxisofttech.hackathonback.service.mapper.EmployeeMapper;
...
class EmployeeResourceIT {
    ...
    private static final String DEFAULT_EMAIL = ")G~I@oKZ\\O0Tzx}";
    private static final String UPDATED_EMAIL = "$9G)@*1e4\\yy#";
    ...
    public static Employee createEntity() {
        return new Employee().name(DEFAULT_NAME).position(DEFAULT_POSITION).email(DEFAULT_EMAIL);
    }
    ...
    public static Employee createUpdatedEntity() {
        return new Employee().name(UPDATED_NAME).position(UPDATED_POSITION).email(UPDATED_EMAIL);
    }
    ...
    void putExistingEmployee() throws Exception {
        ...
        updatedEmployee.name(UPDATED_NAME).position(UPDATED_POSITION).email(UPDATED_EMAIL);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.name(UPDATED_NAME).position(UPDATED_POSITION).email(UPDATED_EMAIL);
