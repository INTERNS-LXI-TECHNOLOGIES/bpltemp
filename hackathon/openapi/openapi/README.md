...
Hackathon Back API documentation
...
[*CompanyResourceApi*](doc/CompanyResourceApi.md) | [**createCompany**](doc/CompanyResourceApi.md#createcompany) | **POST** /api/companies | 
[*CompanyResourceApi*](doc/CompanyResourceApi.md) | [**deleteCompany**](doc/CompanyResourceApi.md#deletecompany) | **DELETE** /api/companies/{id} | 
[*CompanyResourceApi*](doc/CompanyResourceApi.md) | [**getAllCompanies**](doc/CompanyResourceApi.md#getallcompanies) | **GET** /api/companies | 
[*CompanyResourceApi*](doc/CompanyResourceApi.md) | [**getCompany**](doc/CompanyResourceApi.md#getcompany) | **GET** /api/companies/{id} | 
[*CompanyResourceApi*](doc/CompanyResourceApi.md) | [**partialUpdateCompany**](doc/CompanyResourceApi.md#partialupdatecompany) | **PATCH** /api/companies/{id} | 
[*CompanyResourceApi*](doc/CompanyResourceApi.md) | [**updateCompany**](doc/CompanyResourceApi.md#updatecompany) | **PUT** /api/companies/{id} | 
[*EmployeeResourceApi*](doc/EmployeeResourceApi.md) | [**createEmployee**](doc/EmployeeResourceApi.md#createemployee) | **POST** /api/employees | 
[*EmployeeResourceApi*](doc/EmployeeResourceApi.md) | [**deleteEmployee**](doc/EmployeeResourceApi.md#deleteemployee) | **DELETE** /api/employees/{id} | 
[*EmployeeResourceApi*](doc/EmployeeResourceApi.md) | [**getAllEmployees**](doc/EmployeeResourceApi.md#getallemployees) | **GET** /api/employees | 
[*EmployeeResourceApi*](doc/EmployeeResourceApi.md) | [**getEmployee**](doc/EmployeeResourceApi.md#getemployee) | **GET** /api/employees/{id} | 
[*EmployeeResourceApi*](doc/EmployeeResourceApi.md) | [**partialUpdateEmployee**](doc/EmployeeResourceApi.md#partialupdateemployee) | **PATCH** /api/employees/{id} | 
[*EmployeeResourceApi*](doc/EmployeeResourceApi.md) | [**updateEmployee**](doc/EmployeeResourceApi.md#updateemployee) | **PUT** /api/employees/{id} | 
