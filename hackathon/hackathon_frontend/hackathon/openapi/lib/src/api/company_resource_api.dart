...
class CompanyResourceApi {
  ...
  const CompanyResourceApi(this._dio, this._serializers);
  ...
  Future<Response<CompanyDTO>> createCompany({ 
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteCompany({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<CompanyDTO>>> getAllCompanies({ 
    int? page = 0,
    int? size = 20,
  ...
  /// Returns a [Future] containing a [Response] with a [CompanyDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CompanyDTO>> getCompany({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [CompanyDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CompanyDTO>> partialUpdateCompany({ 
    required int id,
    required CompanyDTO companyDTO,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [CompanyDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CompanyDTO>> updateCompany({ 
    required int id,
    required CompanyDTO companyDTO,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
