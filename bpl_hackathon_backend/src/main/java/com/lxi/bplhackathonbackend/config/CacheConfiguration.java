package com.lxi.bplhackathonbackend.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.lxi.bplhackathonbackend.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.lxi.bplhackathonbackend.repository.UserRepository.USERS_BY_EMAIL_CACHE);
