...
import static com.lxi.hackathonbackend.domain.CompanyAsserts.*;
import static com.lxi.hackathonbackend.web.rest.TestUtil.createUpdateProxyForBean;
...
import com.lxi.hackathonbackend.domain.Company;
import com.lxi.hackathonbackend.repository.CompanyRepository;
...
class CompanyResourceIT {
    ...
    public static Company createEntity() {
        return new Company().name(DEFAULT_NAME).location(DEFAULT_LOCATION);
    }
    ...
    public static Company createUpdatedEntity() {
        return new Company().name(UPDATED_NAME).location(UPDATED_LOCATION);
    }
    ...
    void putExistingCompany() throws Exception {
        ...
        updatedCompany.name(UPDATED_NAME).location(UPDATED_LOCATION);
    ...
    void fullUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.name(UPDATED_NAME).location(UPDATED_LOCATION);
