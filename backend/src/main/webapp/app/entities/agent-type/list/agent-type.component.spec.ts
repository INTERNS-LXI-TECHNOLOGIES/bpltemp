...
import { sampleWithRequiredData } from '../agent-type.test-samples';
...
describe('AgentType Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.agentTypes()[0]).toEqual(expect.objectContaining({ id: 24386 }));
  });

  describe('trackId', () => {
    it('Should forward to agentTypeService', () => {
      const entity = { id: 24386 };
      jest.spyOn(service, 'getAgentTypeIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAgentTypeIdentifier).toHaveBeenCalledWith(entity);
