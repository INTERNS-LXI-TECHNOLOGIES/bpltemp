...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.bpl.domain.AgentType.class.getName());
            createCache(cm, com.bpl.domain.AgentType.class.getName() + ".organisations");
            createCache(cm, com.bpl.domain.Organisation.class.getName());
