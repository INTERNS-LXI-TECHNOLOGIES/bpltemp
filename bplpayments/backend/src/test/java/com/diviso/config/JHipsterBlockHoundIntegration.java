...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.diviso.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.diviso.security.DomainUserDetailsService", "createSpringSecurityUser");
