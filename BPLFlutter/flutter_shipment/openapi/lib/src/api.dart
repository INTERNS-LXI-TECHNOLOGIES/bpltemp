...
import 'package:openapi/src/api/facility_type_resource_api.dart';
...
class Openapi {
  ...
  /// Get FacilityTypeResourceApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  FacilityTypeResourceApi getFacilityTypeResourceApi() {
    return FacilityTypeResourceApi(dio, serializers);
  }
  ...
  /// Get ShipmentMethodResourceApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  ShipmentMethodResourceApi getShipmentMethodResourceApi() {
    return ShipmentMethodResourceApi(dio, serializers);
  }
