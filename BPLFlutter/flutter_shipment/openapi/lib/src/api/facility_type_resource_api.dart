...
class FacilityTypeResourceApi {
  ...
  Future<Response<FacilityTypeDTO>> createFacilityType({
    ...
    final _path = r'/api/facility-types';
    ...
    return Response<FacilityTypeDTO>(
      data: _responseData,
  ...
  Future<Response<BuiltList<FacilityTypeDTO>>> getAllFacilityTypes({
    ...
    BuiltList<FacilityTypeDTO>? _responseData;
    ...
    return Response<BuiltList<FacilityTypeDTO>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
